...
@app.route('/api/debug/add-bib-500', methods=['POST'])
def add_bib_500():
    """Add bib 500 to roster for testing"""
    global roster_data
    roster_data['500'] = {
        'name': 'Test Runner 500',
        'first_name': 'Test', 
        'last_name': 'Runner 500',
        'age': '28',
        'gender': 'M',
        'city': 'TestCity',
        'state': 'TC',
    ...
    return jsonify({'success': True, 'message': 'Added bib 500', 'roster_count': len(roster_data)})


@app.route('/api/debug/add-bib-12', methods=['POST'])
def add_bib_12():
    """Add bib 12 to roster for testing"""
    global roster_data
    roster_data['12'] = {
        'name': 'Test Runner 12',
        'first_name': 'Test', 
    ...
    return jsonify({'success': True, 'message': 'Added bib 12', 'roster_count': len(roster_data)})
