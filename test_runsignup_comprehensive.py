                    ...
                    if provider_events:
                        ...
                        for event in events_to_test:
                            ...
                            try:
                                ...
                                logger.info(f"✅ Event {event_id} ({event_data.get('name')}): {participant_count} participants")
    ...
    def test_bib_assignment_triggers(self, test_partner_id: int = None) -> Dict:
        ...
        try:
            ...
            for event in future_events:
                ...
                if bib_numbers:
                    logger.info(f"   • Bib range: {min(bib_numbers)} - {max(bib_numbers)}")
...
def main():
    ...
    if args.test == 'full':
        ...
        print(f"\nTest completed. Results: {json.dumps(result, indent=2, default=str)}")
        ...
        print(f"\nAll tests completed. Check test_results_comprehensive.json for detailed results.")
